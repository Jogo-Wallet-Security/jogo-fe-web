...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[linear-gradient(to_right,#679EF8,#87B2F9,#769FF9,#AADEFD,#9FE1FA)] px-20 py-6">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_bottom,transparent_0%,transparent_60%,#D6E7FF_90%)]" />

      <div className="relative max-w-7xl mx-auto">
        <Navbar />

        {/* Hero */}
        <section className="mt-12 flex flex-col items-start w-full text-start">
          {/* Heading */}
          <motion.h1
